...
<head>
    ...
    <meta property=og:description content="Record your calls and monitor your performance. Call recordings let you review and analyze your client interactions so that you can improve your voice processes"/>
    ...
    <meta name="twitter:title" content="Record Phone Calls | JustCall">
    <meta name="twitter:description" content="Record your calls and monitor your performance. Call recordings let you review and analyze your client interactions so that you can improve your voice processes">
                ...
                <div class="row agency_featured_item flex-row-reverse">
                    <div class="col-md-6">
                        <div class="agency_featured_img text-right">
                            <img src="https://cdn.justcall.io/images/justcall-recordcalls.png" style="width: 100%" alt="">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="agency_featured_content pr_70 pl_70">
                           
                            <h3>Record Phone Calls</h3>
                            <p>Record your calls and monitor your performance as a team. Call recordings let you review and analyze your client interactions so that you can improve your voice processes
                            Get real time, actionable insights and minimize risk with Justcall’s business call recording.</p>
                            <p> With Just Call you can</p>
                            <ul>
                                <li>Easily play the recorded calls.</li>
                                <li>Access personalized call recordings of each team member through their profile.</li>
                                <li>Share the recordings with anyone you want, by just sending a link.</li>
                            </ul>
