<?php 
 ...
 $headline = 'Call Distribution';
 $breadcrumb = array(array("name"=>"Home","link"=>"index.php"),array("name"=>"Features","link"=>"features.php"),array("name"=>$headline, "link"=>""));
?>
    ...
    <section class="breadcrumb_area">
        ...
        <div class="container">
            <div class="breadcrumb_content text-center">
                <h1 class="f_p f_700 f_size_50 w_color l_height50 mb_20">Call Distribution</h1>
                ...
                <div class="row agency_featured_item flex-row-reverse" style="margin-top: 50px;">
                    <div class="col-md-6">
                        <div class="agency_featured_img text-right" >
                            <img src="https://cdn.justcall.io/images/calldistribution.jpg" style="width: 50%" alt="">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="agency_featured_content pr_70 pl_70">
                            ...
                            <p>Manage your phone calls as a team to handle more incoming calls. With Justcall you can prioritize your phone calls among your team mates to get the best possible response.
                            Match your high-profile clients to your best sales rep to get the most out of your voice processes.</p>
