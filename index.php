...
<head>
    ...
    <link rel="stylesheet" href="//cdn.justcall.io/landing/vendors/bootstrap-selector/css/bootstrap-select.min.css">
    <!--icon font css-->
    ...
    <link rel="stylesheet" href="//cdn.justcall.io/landing/vendors/nice-select/nice-select.css">
...
<body>
            ...
            <div class="row">
                <div class="col-lg-5 d-flex align-items-center">
                    <div class="agency_content">
                        <h2 class="f_700 t_color3 mb_40 wow fadeInLeft" data-wow-delay="0.3s">Strategic design and technology agency</h2>
                        <p class="f_300 l_height28 wow fadeInLeft" data-wow-delay="0.4s">Why I say old chap that is spiffing off his nut arse pear shaped plastered Jeffrey bodge barney some dodgy.!!</p>
    ...
    <section class="agency_service_area bg_color">
        <div class="container custom_container">
            <h2 class="f_size_30 f_600 t_color3 l_height40 text-center mb_90 wow fadeInUp" data-wow-delay="0.2s">You SaasLand wherever your<br> business agency</h2>
            <div class="row mb_30">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="p_service_item agency_service_item pl_50 wow fadeInUp" data-wow-delay="0.8s">
                        <div class="icon">
                            <img src="img/home4/icon_shape4.png" alt="">
    ...
    <section class="agency_about_area d-flex bg_color">
        <div class="col-lg-6 about_content_left ">
            <div class="about_content mb_30">
                ...
                <p class="f_size_15 f_300 mb_40">Why I say old chap that is spiffing bodge, blag pardon me buggered mufty Oxford butty bubble and squeak wind up, brown bread the full monty bloke ruddy cras tickety-boo squiffy.!</p>
                <a href="#" class="about_btn">Meet Your Team</a>
            </div>
        </div>
    ...
    <section class="agency_featured_area bg_color">
        <div class="container">
            <h2 class="f_size_30 f_600 t_color3 l_height40 text-center wow fadeInUp" data-wow-delay="0.3s">You SaasLand wherever your<br> business agency</h2>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="action_content text-center">
                        <h2 class="f_600 f_size_30 l_height45 mb_40">Ready to enjoy SaasLand and expenses?</h2>
                        <a href="#" class="about_btn white_btn wow fadeInLeft" data-wow-delay="0.3s">Just SaasLand IT</a>
    ...
    <script src="//cdn.justcall.io/landing/vendors/bootstrap-selector/js/bootstrap-select.min.js"></script>
    ...
    <script src="//cdn.justcall.io/landing/vendors/nice-select/jquery.nice-select.min.js"></script>
