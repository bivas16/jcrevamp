...
<head>
    ...
    <!-- Bootstrap CSS -->
    <!-- <link rel="stylesheet" href="//cdn.juscss/bootstrap.min.css"> -->
                ...
                <div class="row s_features_item">
                    ...
                    <div class="col-lg-6 d-flex align-items-center">
                        <div class="s_features_content pl_120">
                            ...
                            <p class="f_size_18 l_height30 f_300 wow fadeInRight" data-wow-delay="0.5s">Use Timeline to plan projects right the first time. See how the pieces fit together so you can spot gaps and overlaps before you start.</p>
                ...
                <div class="row s_features_item s_features_item_two flex-row-reverse mt_100">
                    ...
                    <div class="col-lg-6 d-flex align-items-center">
                        <div class="s_features_content pr_120">
                            ...
                            <p class="f_size_18 l_height30 f_300 wow fadeInLeft" data-wow-delay="0.5s">Why I say old chap that is spiffing lavatory chip shop gosh off his nut, smashing boot are you taking the piss posh loo brilliant matie boy.!</p>
    ...
    <section class="software_promo_area sec_pad">
        <div class="container">
            <div class="sec_title text-center wow fadeInUp" data-wow-delay="0.3s">
                ...
                <p class="f_300 f_size_18 l_height34">Why I say old chap that is spiffing lavatory chip shop gosh off his nut, smashing boot<br> are you taking the piss posh loo brilliant matie boy.!</p>
            </div>
            ...
            <div class="row mb_30">
                <div class="col-lg-4 col-sm-6">
                    <div class="s_pricing-item wow fadeInLeft" data-wow-delay="0.4s">
                        ...
                        <p class="f_p f_300">Create your first online course</p>
                        <div class="price f_size_40 f_p f_700">$49.00<sub class="f_300 f_size_16">/ mo</sub></div>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="s_pricing-item wow fadeInUp" data-wow-delay="0.6s">
                        ...
                        <p class="f_p f_300">Our most popular plan</p>
                        <div class="price f_size_40 f_p f_700">$49.00<sub class="f_300 f_size_16">/ mo</sub></div>
                        <ul class="list-unstyled mt_30">
                            <li>Product Recommendations</li>
                            <li>Abandoned Cart</li>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="s_pricing-item wow fadeInRight" data-wow-delay="0.8s">
                        ...
                        <p class="f_p f_300">Experience thebest of lorem</p>
                        <div class="price f_size_40 f_p f_700">$99.00<sub class="f_300 f_size_16">/ mo</sub></div>
                        <ul class="list-unstyled mt_30">
                            <li>Product Recommendations</li>
                            <li>Abandoned Cart</li>
                            <li>Facebook & Instagram Ads</li>
    ...
    <section class="s_subscribe_area">
        ...
        <div class="container">
            <div class="sec_title text-center mb_50 wow fadeInUp" data-wow-delay="0.4s">
                ...
                <p class="f_300 f_size_18 l_height34">Instant Sign Up. Cancel Anytime. No Credit Card Required</p>
            </div>
