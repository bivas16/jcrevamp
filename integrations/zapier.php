            ...
            <div class="row" style="margin-top: 26px;">
                <div class="col-lg-6 d-flex align-items-center">
                    <div class="developer_product_content d_product_content_two">
                        <h2 class="f_600 f_size_30 l_height30 t_color3 mb_50">Use Zapier triggers, achieve everything you want with your calls and contacts.</h2>
                ...
                <div class="col-lg-6">
                    <img class="service_tab_img" src="https://cdn.justcall.io/images/zapier-screenshot.png" style="width: 726px;" alt="">
                </div>
            </div>
        </div>
    </section>
