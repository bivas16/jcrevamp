<?php 
 ...
 $headline = 'Make and Receive Calls';
                ...
                <div class="row agency_featured_item flex-row-reverse">
                    <div class="col-md-6">
                        <div class="agency_featured_img text-right">
                            <img src="https://justcall.io/ckassets/images/desktop-app.png" style="width: 100%" alt="">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="agency_featured_content pr_70 pl_70">
                            
                            <h3>Make and receive calls at your desk using JustCall desktop apps for Windows, Mac & Linux.</h3>
