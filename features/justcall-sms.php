...
<head>
    ...
    <meta property=og:description content="Justcall lets you send SMS to all your contacts."/>
    ...
    <meta name="twitter:title" content="Send and Receive SMS | JustCall">
    <meta name="twitter:description" content="Justcall lets you send SMS to all your contacts.">
                ...
                <div class="row agency_featured_item flex-row-reverse">
                    <div class="col-md-6">
                        <div class="agency_featured_img text-right">
                            <img src="https://cdn.justcall.io/images/justcall-messages.jpg" style="width: 50%" alt="">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="agency_featured_content pr_70 pl_70">
                            
                            <h3>Send and Receive SMS</h3>
                            <p>Send and receive text messages from your Justcall phone number. Justcall lets you send SMS to all your contacts. Manage your Inbox and swiftly handle your clients and customers.</p>
                            ...
                            <ul>
                                <li>Send messages to your clients.</li>

                                <li>Immediately inform and communicate to your clients or teammates.</li>
                                
                                <li>Personalize your daily communication and save time.</li>
                            </ul>
