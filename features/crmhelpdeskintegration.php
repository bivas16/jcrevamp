<?php
 $headline = 'CRM & Helpdesk Integration';
    ...
    <section class="breadcrumb_area">
        ...
        <div class="container">
            <div class="breadcrumb_content text-center">
                <h1 class="f_p f_700 f_size_50 w_color l_height50 mb_20">CRM & Helpdesk Integration</h1>
                ...
                <div class="row agency_featured_item flex-row-reverse" style="margin-top: 50px;">
                    <div class="col-md-6">
                        <div class="agency_featured_img text-right">
                         <img src="https://justcall.io/ckassets/images/integrations.png" style="width: 100%" alt="">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="agency_featured_content pr_70 pl_70">
                            
                            <h3>Integrates with your CRM or Helpdesk</h3>
                            <p>JustCall integrates with popular CRM & Helpdesk systems and automatically synchronize all calling activities with your CRM & Helpdesk system.</p>
