...
<head>
    ...
    <meta name="description"
          content="Auto Dialer by JustCall allows you to run automated outbound calling campaigns. It saves your agents time & efforts while increasing your sales."/>
    <meta name="keywords"
          content="autodialer, auto dialer, predictive dialer, outbound call campaigns, bulk calling, call center system,desktop mobile,receive call online,cloud contact center software,call center phone system,cloud call center software,call center support software,phone systems for call centers,free call system,call from desktop,business phone software,desktop calling software,virtual phone number,virtual number,virtual phone system,virtual telephone number,virtual mobile number,voip number,localphone,voip phone,international calling,voip call,voip phone service,international phone number,virtual phone,international number,local number,free virtual number,voip phone number,call forwarding service,call center software,ivr system,forward calls ,call center solutions,call centre solutions,call center software solutions,call center solution provider,cloud call center solutions ,phone call center"/>
  <meta name=email content="help@justcall.io">
  <meta name=robots content="index,follow">
  <meta property=og:title content="Auto Dialer - Automate Your Outbound Call Campaigns | JustCall"/>
  <meta property=og:image content="//cdn.justcall.io/images/autodialer-sales.png"/>
  <meta property=og:type content=website />
  <meta property=og:url content="https://justcall.io/autodialer"/>
  ...
  <meta property=og:description content="Auto Dialer by JustCall allows you to run automated outbound calling campaigns. It saves your agents time & efforts while increasing your sales."/>
  ...
  <meta name="twitter:title" content="Auto Dialer - Automate Your Outbound Call Campaigns">
  <meta name="twitter:description" content="Auto Dialer by JustCall allows you to run automated outbound calling campaigns. It saves your agents time & efforts while increasing your sales.">
  <meta name="twitter:image" content="//cdn.justcall.io/images/autodialer-sales.png">
                ...
                <div class="row agency_featured_item mt-0 flex-row-reverse">
                    <div class="col-md-6">
                        <div class="agency_featured_img text-right">
                            <img src="https://justcall.io/app/assets/images/autodialer-screenshot.png" style="width: 100%;" alt="">
                        </div>
                    </div>
                    <div class="col-md-6">
